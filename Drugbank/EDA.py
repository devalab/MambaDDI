...
# Load your CSV
df = pd.read_csv("/home2/jessygrace.polinati/Abhi/dd/DrugBank_DDI_with_negatives.csv")
...
# --- Save to text file ---
with open("/home2/jessygrace.polinati/Abhi/dd/class_stats_negative_sampling.txt", "w") as file:
    file.write("\n".join(output_text))
